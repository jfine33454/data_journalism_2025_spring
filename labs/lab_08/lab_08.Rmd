...
**A3.** Looking at the scatterplot, I see that there is a correlation between 911 calls and lower income areas. For example, lower income areas have a higher amount of calls. However, this isn't the only factor. There isn't really a clear pattern, between an income of 90,000-120,000 there are still some peak amount of calls. There is sort of an indication that this pattern is true, but there are probably other factors that are effecting 911 calls and incomes. 
