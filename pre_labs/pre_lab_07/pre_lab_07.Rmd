...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer** The state with the largest percent change is Nevada 
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer** The county with the highest mediam income is Howard County 
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer**It should be renamed to include the margin of error. And also include that it is median income. 
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer** High schools where 60% or more of graduates immediatly enrolling in college have an average income of around $111,448. Meanwhile those with less than 40% have an average income of about $69,252. 
...
**Task** What is another question you could ask of this data? **Answer** There are tons of different questions I can ask the data like does a higher median income mean a higher rate of immediate enrollment to college? 
