...
**Answer** 79366 obs. of 9 variables 
...
In the space below, write the data type for the "id" column and the "seats" column (it's in light gray, offset by \< \>). **Answer** <chr>
...
**Answer** I think it is telling me how many students take the class per year or "term"
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** The years are different, they are more current. That also changes the count class amounts, it makes them match up with the specific years.
...
**Answer** The output was changed by using the different code group by, term and department. This added the filtering by department.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** This adds the filter of total seats, now the table tells you the total seats per term. 
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer** Now, the codes for the median and mean seats are in place so they are displayed on the dataframe. The result is a table with even more information. 
...
**Answer** The code adding the maximum and minimun seats were introduced, making them show up on the table. The result now has 5 different filters and categories. 
...
1.  How many seats were available in 2018 in the journalism department? 

2.  How many total seats were there in 2024 in the sociology department? 

3.  What was the mean (average) number of seats in 2020 in the department of public policy? 
